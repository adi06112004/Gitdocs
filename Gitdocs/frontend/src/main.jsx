...
import {
  loadProjectsFromStorage as loadProjects,
  fetchProjectsRequest,
} from "./store/slices/projectSlice";
import {
  loadDocumentsFromStorage as loadDocuments,
...
if (authData?.token) {
  store.dispatch(fetchProjectsRequest());
  store.dispatch(fetchDocumentsRequest());
}
